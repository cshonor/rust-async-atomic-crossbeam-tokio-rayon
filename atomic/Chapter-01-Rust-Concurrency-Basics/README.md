...
**Mutex / 自旋 / 锁优化（跨第 1/4/8/9 章）**：[互斥锁与锁体系-贯通笔记.md](../互斥锁与锁体系-贯通笔记.md)  
**RwLock / 写者饥饿 / 写优先（第 1、9 章）**：[RwLock与读写锁体系-贯通笔记.md](../RwLock与读写锁体系-贯通笔记.md)  
**Condvar / 生产者-消费者（第 1、8、9 章）**：[Condvar与条件变量-贯通笔记.md](../Condvar与条件变量-贯通笔记.md) · 代码 `use_condvar.rs`
